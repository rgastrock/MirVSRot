...
We find evidence for generalization for the far target, but not the middle and near targets. However, on average, completion times during the first block of the test quadrant are shorter compared to the first block of reaches to the training quadrant.
...
We find evidence for generalization to quadrant 2.
...
We do not find evidence of generalization across hands, and even the completion times on average do not differ much between the first blocks of reaches with the trained or untrained hand.
...
In comparing quadrants 1 and 4, we find evidence of generalization for the far target, but not for the middle and near targets. However, on average, path lengths are shorter for the first block of reaches to the test quadrant, compared to the first block of reaches to the training quadrant.
...
In comparing quadrants 1 and 2, we find evidence for generalization with the middle target, but not the far and near targets. However, on average, path lengths are shorter for the first block of reaches to the test quadrant, compared to the first block of reaches to the training quadrant.
...
```
Finally, in comparing the two hands, we do not find evidence of generalization across hands, and even the path lengths on average do not differ much between the first blocks of reaches with the trained or untrained hand.
